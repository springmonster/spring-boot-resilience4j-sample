...
import com.example.resilience4j.service.Service;
...
public class BackendControllerC {

    private final Service businessCService;

    public BackendControllerC(@Qualifier("backendCService") Service businessCService) {
